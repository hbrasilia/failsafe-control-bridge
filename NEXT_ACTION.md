...
1.  **Snapshot Contabo**: Snapshot de seguranÃ§a da VPS pendente de comprovaÃ§Ã£o.
2.  **Firewall UFW**: PolÃ­tica de blindagem de rede definida e validada.
3.  **Segredos no GitHub Secrets**: Cadastro e aprovaÃ§Ã£o das chaves:
