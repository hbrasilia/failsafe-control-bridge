...
37. **Próxima Fila Prioritária (Bloqueada)**: Iniciar o packet **FS-INFRA-017 / RLS-STAGE-001** (implantação física de banco PostgreSQL com `pgvector` e RLS na VPS Contabo) assim que as credenciais GitHub Secrets e snap/backup Contabo forem liberados.
