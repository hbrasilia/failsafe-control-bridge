...
## 11. Staging FÃ­sico
- **Status**: `BLOCKED_WAITING_GATES` (AvaliaÃ§Ã£o de provimento de gates FS-INFRA-017-GATE-PROVISION realizada; pendente segredos e snapshot Contabo).



## 12. Gates FÃ­sicos Pendentes
1. ComprovaÃ§Ã£o de Snapshot na VPS Contabo (BLOCKED_BY_ACCESS).
...
3. AprovaÃ§Ã£o fÃ­sica formalizada pelo CEO em `NEXT_ACTIONS_QUEUE.md` / `DECISIONS.md`.
...
- **Reparo do Bridge**: `CONCLUÃDO` (PUBLIC-BRIDGE-REPAIR-001 mesclado no PR #2, removendo mojibake e alinhando decisÃµes).
